...
class LinearRegression {
    ...
    test(testFeatures, testLabels) {
        ...
        const res = testLabels.sub(predictions).pow(2).sum().get(); // sum of squares of residuals ... SSR
        const tot = testLabels.sub(testLabels.mean()).pow(2).sum().get(); // Total sum of squares ... SST
        return 1 - res / tot; // Coeffienct of Determinaton
    }
